    ...
    return ( 
        <div className="flex flex-col-2 font-sans h-screen">
            <div className="flex-2 w-1/2  h-screen bg-[#F07B52] justify-center font-bold text-white text-center relative ">
                <h1 className="text-5xl m-auto justify-center text-center  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    Welcome
                </h1>
                <p className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-12">
                    Welcome to Go Inventory. Please sign up to get started. 
                </p>
            </div>
            ...
            <h1 className="text-5xl mb-6 text-[#F07B52] font-bold">
                ...
                <form >
                <label htmlFor="Name" className="font-extralight text-[#F07B52]">Fullname</label>
          <br></br>
          <input
            name="name"
            placeholder="name"
            className="h-[40px] w-96  border-2 border-[#F07B52]  rounded-lg px-2"
            required
          />
          <br /> <br />
          ...
          />
             <br /> <br />
                <label htmlFor="ConfirmPassword" className="font-extralight text-[#F07B52]" >Confirm Password</label>
          <br></br>
          <input
          ...
          />
                ...
                <p className="mt-2">Already have an account? <a href="" className="text-[#F07B52] hover:text-black ">SignIn</a></p>
                <button className="justify-center  pl-5 pr-5 bg-[#F07B52] text-white hover:text-[#F07B52] hover:bg-white p-4 mt-5 border-2 border-[#F07B52] rounded-xl cursor-pointer duration-300">
                    Sign Up
                </button>
            </div>
        </div>
